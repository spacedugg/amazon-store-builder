...
export async function aiGeneratePageLayout(pageName, pageProducts, brand, lang, isHomepage, allCategories, analysis, userInstructions, complexityLevel, category, template, websiteData, referenceAnalysis, isSubpage, structuralBlueprint) {
  ...
  var system = [
    ...
    '- Briefs MUST be 20-40 words. Not too short (designer needs enough direction), not too long.',
    '- Describe WHAT the image shows: subject, scene, composition, mood, people, setting, product interaction.',
    '- For LIFESTYLE briefs: Be SPECIFIC about the scene. Describe the person (age, gender, activity), setting (indoor/outdoor, environment), and how the product is used.',
    '  GOOD: "Woman mid-30s drinking from bottle after outdoor jog, park setting, sweaty, satisfied expression, product prominent in hand"',
    '  BAD: "Person using product in lifestyle setting"',
    '- For CREATIVE briefs: Describe the visual concept, composition, and elements (product placement, graphics, text areas).',
    '- The designer knows the brand CI. Do NOT specify colors, backgrounds, gradients, or font styles.',
