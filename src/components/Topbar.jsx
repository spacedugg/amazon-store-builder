export default function Topbar({ store, onGenerate, onShowAsins, onExport, onSave, viewMode, onToggleView }) {
  return (
    <div className="topbar">
      ...
      {store.pages.length > 0 && (
        <>
          ...
          <button className="btn" onClick={onSave} title="Save store">Save</button>
          <button className="btn" onClick={onExport} title="Export Designer Briefing">Export DOCX</button>
        </>
      )}
