...
var REFACTOR_PROMPT = 'Aktiviere den Skill amazon-storefront-design (Source: .claude/skills/amazon-storefront-design/SKILL.md im Repo amazon-store-builder) im Refactor Mode. Ich will meinen bestehenden Brand Store nach den aktuellen Skill Regeln neu generieren ohne von Null anzufangen.\n\nDer Skill nutzt eine v4-Wissensbasis aus 20 analysierten Stores (Phase-3-Analyses, Per-Page-Blueprints, Voice-/Hero-/Page-Architecture-Vokabular). Beim Refactor werden alle Pages gegen das aktuelle Vokabular gemappt und Self-Check-Regeln strikt angewendet, inklusive CLAUDE.md Paragraf 0 (strukturell-uebertragbar vs. brand-spezifisch).\n\nHier mein aktueller Store als File Attachment (lade ich gleich an).\n\nWende alle aktuellen Self Check Regeln neu auf jede Page an. Behalte folgende Felder pro Tile unverändert:\n- uploadedImage, uploadedImageMobile, videoThumbnail, wireframeImage, referenceImages\n- asins, linkAsin, hotspots, imageRef Solo Suffixe\n- productSelector Schema\n- bgColor, textAlign\n\nÄndere wo nötig:\n- Headlines, Subheadings, Bodies, Bullets, CTAs nach Brand Voice und Headline Regeln\n- voiceMarkers-Tags pro Page auf die aktuellen v4-Werte mappen (12 voiceRegister inkl. freundlich, abenteuerlich, jung_lebendig, expert_endorsement)\n- Layouts wo ASIN Grid Stacks vorhanden sind\n- imageCategory Defaults wo nicht passend\n- Section Reihenfolge wo nötig um Stacks aufzulösen\n- Brand Story Tiles auf image (kein image_text mehr)\n- Versand und Lieferung Phrasen ersatzlos streichen\n- Brand-Spezifik-Bleed Check: konkrete Bildmotive oder Headlines aus Quell-Stores entfernen, falls sie unbeabsichtigt durchgesickert sind\n\nGib am Ende den aktualisierten Store als kompletten JSON zurück plus eine kurze Diff Liste (was wurde geändert). Ich importiere ihn dann über "Neuer Store" plus "JSON Datei wählen" zurück ins Tool.';
