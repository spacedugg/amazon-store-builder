...
export var STORE_TEMPLATES = [
  ...
  },
  {
    ...
    homepage: [
      { layout: '1', purpose: 'Hero banner', tileTypes: ['image'], brief: '[LIFESTYLE] product in elegant premium setting' },
      { layout: 'vh-w2s', purpose: 'Category navigation', tileTypes: ['image','image','image'], brief: '[LIFESTYLE] wide category lifestyle + 2 square subcategory tiles' },
      { layout: '1', purpose: 'Shoppable lifestyle', tileTypes: ['shoppable_image'], brief: '[SHOPPABLE] premium setting with products' },
      { layout: '1', purpose: 'Product grid bestsellers', tileTypes: ['product_grid'], brief: '' },
      { layout: 'std-2equal', purpose: 'Brand story / sustainability', tileTypes: ['image','image'], brief: '[CREATIVE] brand heritage/origin + sustainability values' },
      { layout: '1', purpose: 'Product grid secondary', tileTypes: ['product_grid'], brief: '' },
      { layout: 'vh-w2s', purpose: 'Trust / values', tileTypes: ['image','image','image'], brief: '[CREATIVE] wide value banner + 2 square pillar icons' },
      { layout: '1', purpose: 'Footer promo', tileTypes: ['image'], brief: '[CREATIVE] brand statement, elegant minimal text' },
    ],
    categoryPage: [
      { layout: '1', purpose: 'Category hero', tileTypes: ['image'], brief: '[LIFESTYLE] category products in premium setting' },
      ...
      { layout: '1', purpose: 'Brand lifestyle video', tileTypes: ['video'], brief: 'Premium lifestyle video: elegant product usage' },
      { layout: '1', purpose: 'Product grid', tileTypes: ['product_grid'], brief: 'ALL category ASINs' },
      { layout: 'vh-w2s', purpose: 'Variant showcase', tileTypes: ['image','image','image'], brief: '[PRODUCT] wide variant overview + 2 square flavor tiles' },
  ...
  },
  {
    ...
    homepage: [
      { layout: '1', purpose: 'Hero banner', tileTypes: ['image'], brief: '[LIFESTYLE] athlete with product, bold tagline' },
      { layout: 'vh-w2s', purpose: 'Category navigation', tileTypes: ['image','image','image'], brief: '[PRODUCT] wide category overview + 2 square packshots' },
      { layout: 'lg-2stack', purpose: 'Bestseller spotlight', tileTypes: ['shoppable_image','image','image'], brief: '[SHOPPABLE] flagship product packshot + [CREATIVE] ingredient/benefit wide tiles' },
      { layout: '1', purpose: 'Video section', tileTypes: ['video'], brief: 'Training footage, product demo, athlete endorsement' },
      { layout: '1', purpose: 'Product grid bestsellers', tileTypes: ['product_grid'], brief: '' },
      { layout: 'vh-w2s', purpose: 'Performance USPs', tileTypes: ['image','image','image'], brief: '[CREATIVE] wide stat banner + 2 square metric tiles (e.g. "30g Protein")' },
      { layout: 'std-2equal', purpose: 'Athlete / social proof', tileTypes: ['image','image'], brief: '[LIFESTYLE] athlete using product + [CREATIVE] testimonial quote card' },
      { layout: '1', purpose: 'Brand mission', tileTypes: ['image'], brief: '[CREATIVE] bold mission statement typography' },
    ],
    categoryPage: [
      { layout: '1', purpose: 'Category hero', tileTypes: ['image'], brief: '[PRODUCT] product range lineup, category name' },
      { layout: 'std-2equal', purpose: 'Product + benefits', tileTypes: ['shoppable_image','image'], brief: '[SHOPPABLE] hero product packshot + [CREATIVE] benefit infographic' },
      { layout: 'vh-w2s', purpose: 'Flavor/variant showcase', tileTypes: ['image','image','image'], brief: '[SHOPPABLE] wide variant overview + 2 square flavor packshots' },
      { layout: '1', purpose: 'Performance training video', tileTypes: ['video'], brief: 'High-energy training video: athlete using product' },
      { layout: '1', purpose: 'Product grid', tileTypes: ['product_grid'], brief: 'ALL category ASINs' },
  ...
  },
  {
    ...
    homepage: [
      { layout: '1', purpose: 'Hero banner', tileTypes: ['image'], brief: '[PRODUCT] clean product arrangement, minimal headline' },
      { layout: 'std-2equal', purpose: 'Category navigation', tileTypes: ['image','image'], brief: '[PRODUCT] product flat-lay, clean category name' },
      { layout: 'lg-2stack', purpose: 'Bestseller spotlight', tileTypes: ['shoppable_image','image','image'], brief: '[SHOPPABLE] hero product + [CREATIVE] minimal benefit wide tiles' },
      { layout: '1', purpose: 'Product grid', tileTypes: ['product_grid'], brief: '' },
      { layout: 'std-2equal', purpose: 'Lifestyle', tileTypes: ['image','shoppable_image'], brief: '[LIFESTYLE] minimal, person using product + [SHOPPABLE] product packshot' },
      { layout: 'vh-w2s', purpose: 'USPs', tileTypes: ['image','image','image'], brief: '[CREATIVE] wide minimal USP banner + 2 square icon tiles' },
      { layout: '1', purpose: 'Brand statement', tileTypes: ['image'], brief: '[CREATIVE] large typography brand statement, one sentence, minimal' },
    ],
    categoryPage: [
      { layout: '1', purpose: 'Category hero', tileTypes: ['image'], brief: '[PRODUCT] category products flat-lay, clean category name' },
      { layout: 'std-2equal', purpose: 'Product detail', tileTypes: ['image','shoppable_image'], brief: '[PRODUCT] material/quality close-up + [SHOPPABLE] product packshot' },
      { layout: '1', purpose: 'Product grid', tileTypes: ['product_grid'], brief: 'ALL category ASINs' },
  ...
  },
  {
    ...
    homepage: [
      { layout: '1', purpose: 'Hero banner', tileTypes: ['image'], brief: '[LIFESTYLE] products with natural ingredients (herbs, seeds)' },
      { layout: 'vh-w2s', purpose: 'Category navigation', tileTypes: ['image','image','image'], brief: '[PRODUCT] wide category overview + 2 square product+ingredient tiles' },
      { layout: 'std-2equal', purpose: 'Ingredient spotlight', tileTypes: ['image','shoppable_image'], brief: '[CREATIVE] ingredient close-up with benefit text + [SHOPPABLE] product packshot' },
      { layout: '1', purpose: 'Product grid', tileTypes: ['product_grid'], brief: '' },
      { layout: '2x2wide', purpose: 'Trust badges', tileTypes: ['image','image','image','image'], brief: '[CREATIVE] certification icon (Bio, Lab-tested, Vegan, Recyclable)' },
      { layout: '1', purpose: 'Brand origin video', tileTypes: ['video'], brief: 'Authentic brand video: founder story, sourcing, production' },
      { layout: '1', purpose: 'Brand story', tileTypes: ['image'], brief: '[CREATIVE] founder story, authentic brand narrative' },
    ...
    categoryPage: [
      { layout: '1', purpose: 'Category hero', tileTypes: ['image'], brief: '[LIFESTYLE] category products with raw ingredients' },
      { layout: 'std-2equal', purpose: 'Benefit + product', tileTypes: ['image','shoppable_image'], brief: '[CREATIVE] ingredient benefit infographic + [SHOPPABLE] product packshot' },
      { layout: 'vh-w2s', purpose: 'Key features', tileTypes: ['image','image','image'], brief: '[PRODUCT] wide ingredient overview + 2 square close-up tiles' },
      { layout: '1', purpose: 'Ingredient journey video', tileTypes: ['video'], brief: 'Ingredients to product journey: sourcing, production' },
      { layout: '1', purpose: 'Product grid', tileTypes: ['product_grid'], brief: 'ALL category ASINs' },
  ...
  },
  {
    ...
    homepage: [
      { layout: '1', purpose: 'Hero banner', tileTypes: ['image'], brief: '[LIFESTYLE] products with bold playful headline, fun props' },
      { layout: 'vh-w2s', purpose: 'Category navigation', tileTypes: ['image','image','image'], brief: '[PRODUCT] wide category overview + 2 square product tiles with fun props' },
      { layout: 'std-2equal', purpose: 'Hero product + lifestyle', tileTypes: ['shoppable_image','image'], brief: '[SHOPPABLE] hero product + [LIFESTYLE] young person using product' },
      { layout: 'lg-4grid', purpose: 'Variant showcase', tileTypes: ['image','shoppable_image','shoppable_image','shoppable_image','shoppable_image'], brief: '[LIFESTYLE] large group shot + [SHOPPABLE] 4 variants' },
      { layout: '1', purpose: 'Product grid', tileTypes: ['product_grid'], brief: '' },
      { layout: 'std-2equal', purpose: 'Social proof / community', tileTypes: ['image','image'], brief: '[LIFESTYLE] UGC/influencer shot + [CREATIVE] community stat' },
      { layout: '1', purpose: 'Video', tileTypes: ['video'], brief: 'Energetic brand video: product in action, lifestyle montage' },
      { layout: '2x2wide', purpose: 'Footer nav', tileTypes: ['image','image','image','image'], brief: '[CREATIVE] category icon, playful thumbnail' },
    ],
    categoryPage: [
      { layout: '1', purpose: 'Category hero', tileTypes: ['image'], brief: '[LIFESTYLE] category products, fun bold category name' },
      { layout: 'vh-w2s', purpose: 'Top picks', tileTypes: ['image','image','image'], brief: '[SHOPPABLE] wide hero product + 2 square variant tiles' },
      { layout: '1', purpose: 'Energetic brand video', tileTypes: ['video'], brief: 'Fast-paced video: young people enjoying product, energetic' },
      { layout: '1', purpose: 'Product grid', tileTypes: ['product_grid'], brief: 'ALL category ASINs' },
      { layout: 'lg-4grid', purpose: 'Flavor exploration', tileTypes: ['image','shoppable_image','shoppable_image','shoppable_image','shoppable_image'], brief: '[LIFESTYLE] large action shot + [SHOPPABLE] 4 variants' },
      { layout: 'std-2equal', purpose: 'Fun fact + cross-sell', tileTypes: ['image','image'], brief: '[CREATIVE] fun product fact + category link with playful visual' },
    ],
  },
];
